...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
      ...
      <h1 className="font-serif text-3xl text-white mb-3">Página no encontrada</h1>
      <p className="text-white/40 font-sans mb-8">La página que buscás no existe o fue movida.</p>
      <Link
        href="/"
